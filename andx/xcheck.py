...
if os.path.exists(scn_c):
    print xgs + "   |_" + xge + "[Sub-Dir] - " + xgs + scn_c + xge + " exists..."
...
if os.path.exists(scn_c_src):
    print xgs + "     |_" + xge + "[SUB_DIR_C] - " + xgs + scn_c_src + xge + " exists..."
